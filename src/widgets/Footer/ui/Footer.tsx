...
const Footer = () => {
    ...
    return (
        <footer className={styles.footer}>
            <div className={styles.container}>
                ...
                <div className={styles.links}>
                    ...
                    <div className={styles.column}>
                        ...
                        <ul className={styles.linklist}>
                            <li>
                                <Link className={styles.link} to={routePaths.home}>{t('footer.termsOfServices')}</Link>
                            </li>
                            <li>
            ...
            <div className={styles.copyRight}>{t('footer.copyRight', { year: "2025", company: "WEGO" })}</div>
        </footer>
    )
}
